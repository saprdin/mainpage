...
- **URL**: https://sia-backrooms.pages.dev/
  - 루트 `/` = `index.html` (아케이드 GAME SELECT 허브)
  - `/backrooms` = 3D 백룸 워킹 갤러리
...
## 알려진 이슈 (배포 환경)
- `index.html` 의 `../Game_1`, `../Game_2` 상대경로 → 배포본엔 해당 폴더가 없어 404.
- `backrooms.html` 사진 라이트박스의 `게임 열기`(`../../../Project/DeepHero/...`) → 404.
